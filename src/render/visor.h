...
namespace sigil::visor {
    ...
    // Renderer API
    sigil::status_t create_render_channel(sigil::window_t *window, sigil::ntt::scene_t *scene);
    sigil::status_t destroy_render_channel(render_channel_t *ch);
    ...
    sigil::status_t start_render_channel(render_channel_t *ch);
    sigil::status_t stop_render_channel(render_channel_t *ch);
